...
<%--    <script src="${pageContext.request.contextPath}/js/orderRecap.js"></script>--%>
    <script src="${pageContext.request.contextPath}/js/stripeError.js"></script>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex">
                        <div class="img" style="background-image: url('/image/attention.jpg'); ">
                        </div>
                        <div class="login-wrap p-4 p-md-5 ">
                            <div class="d-flex ">
                                <div class="w-100">
                                    <h3 class="mb-1">ERREUR DE PAIEMENT</h3>
                                </div>
