...
$(document).ready(function () {
    ...
    function makeActionNonlus(data, type, full, meta) {
        return '<div class="row"><div class="col-4 text-center">\n' +
            '                                         <button onclick="togglePopup(' + full.feedbackId + ')" data-toggle="tooltip" data-placement="top" title="Voir le feedback" >\n' +
            ...
            '                                    <div class="col-4 text-center">\n' +
            '\n' +
            '                                            <button  data-toggle="tooltip" type="submit" data-toggle="tooltip" data-placement="top" title="marquer comme lu" onclick="actionDeleteFeedback(' + full.feedbackId + ')">\n' +
...
function callAjaxIsReadFeedback(id) {
    ...
    data.feedbackId = id;
    $.ajax({
        type: "POST", url: pageContextPath + "/feedbackList/statutlu",
        data: data, success: successIsRead, fail: fail
    });
}
